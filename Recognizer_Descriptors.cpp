...
namespace Faces {
    ...
    Recognizer_Descriptors::Recognizer_Descriptors(Callbacks *callbacks, cv::Size faceSize,
                                                   std::string classifierFile, std::string descriptorFile)
            : Recognizer(callbacks, faceSize) {
        load(classifierFile, descriptorFile);
    }

    void Recognizer_Descriptors::recognize(Face &face) {
        if (!ok)
            return;
    ...
    void Recognizer_Descriptors::train(std::string samplesDir) {
    ...
    void Recognizer_Descriptors::getDescriptors(Face &face) {
    ...
    bool Recognizer_Descriptors::save(std::string file) {
        try {
    ...
    std::map<std::string, int> Recognizer_Descriptors::getSamples(std::string dir) {
    ...
    std::string Recognizer_Descriptors::addSample(std::string storage, Face &face) {
    ...
    void Recognizer_Descriptors::setThreshold(double val) {
        threshold = val;
    }

    void Recognizer_Descriptors::load(std::string classifierFile, std::string descriptorFile) {
        try {
