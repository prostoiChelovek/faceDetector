...
namespace Faces {
    namespace Recognition {
        ...
        void Descriptors::train(std::string samplesDir) {
        ...
        void Descriptors::getDescriptors(Face &face) {
        ...
        bool Descriptors::save(std::string file) {
            try {
        ...
        std::map<std::string, int> Descriptors::getSamples(std::string dir) {
        ...
        std::string Descriptors::addSample(std::string storage, Face &face) {
        ...
        void Descriptors::setThreshold(double val) {
            threshold = val;
        }

        void Descriptors::load(std::string classifierFile, std::string descriptorFile) {
            try {
